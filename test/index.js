...
describe('Import type test', function() {
  ...
  it(`strips non-valid JSON values from JS exports`, function() {
    function render() {
      sass.renderSync({
        file: './test/fixtures/non-valid-json/style-js.scss',
        importer: jsonImporter
      });
    }
  ...
  it(`throws when importing non-valid JSON from JS exports`, function() {
    function render() {
      sass.renderSync({
    ...
    expect(render).to.throw(`Invalid CSS after "module.exports": expected "{", was "= function() {};"`);
  });
